...
def print_XY(chromosome, i):
    # print('-'*30)
    print(f'chromosome {i+1} is: \n x = {chromosome[(len(chromosome)//2):]}  \
      \n y = {chromosome[0:(len(chromosome)//2)]}')
    print(f'Objective value: {Objetive_value(chromosome)[2]:.3f}')
    print('-'*30)
...
# print('-'*30)
# print('\nTesting new chromosome for decoding,')
